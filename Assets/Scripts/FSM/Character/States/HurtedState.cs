...
public class HurtedState : FSMState {
    ...
    public override void EnterState (FSMBase fsm) {
        ...
        fsm.moveVelocity = fsm.hurtedDir;
    ...
    public override void ActionState (FSMBase fsm) {
        ...
        //Debug.Log ("hurtedDir:" + fsm.hurtedDir);
        //fsm.rb.velocity = fsm.hurtedDir * fsm.hurtedSpeed * Time.deltaTime * ConstantList.speedPer;
    }

    public override void ExitState (FSMBase fsm) {
        //fsm.material.SetFloat("FlushAmount",0f);
        //删除映射
        fsm.m_speed = originSpeed;
        ClearAll ();
    }
}